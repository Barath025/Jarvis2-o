...
export default defineConfig(({mode}) => {
  ...
  // Default credentials if not provided in environment
  const GEMINI_API_KEY = process.env.GEMINI_API_KEY || env.GEMINI_API_KEY || env.VITE_GEMINI_API_KEY || 'AIzaSyC1pB_DrZBLEMrElTM2nhcbKJ1SDMUPp9k';
